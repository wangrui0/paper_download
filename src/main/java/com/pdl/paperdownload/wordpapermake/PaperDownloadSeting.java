...
public class PaperDownloadSeting {
  ...
  public static void zipdocx(Map<String, Object> paperMap, ZipOutputStream zipout)
  ...
  public static File makeDirs() {
    String filePath = PaperDownloadSeting.class.getClassLoader().getResource("").getPath()
