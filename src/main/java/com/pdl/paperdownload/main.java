...
public class main {
  ...
  public String paperDownload(@RequestParam Map<String, Object> requestMap, HttpServletRequest request,
    ...
    try {
      ...
      filename = !userAgent.contains("Chrome") ? new String(filename.getBytes("UTF-8"), "ISO-8859-1")
